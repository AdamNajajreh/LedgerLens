...
export const Layers_content = () => {
  ...
  return (
    <div
      ref={scrollRef} // ✅ THIS WAS MISSING
      className="h-screen w-full overflow-y-scroll text-white snap-y snap-mandatory relative scrollbar-hide"
    >
      {/* Hero Section */}
      ...
      {/* Layer 2 Section */}
      <section id="section-2" className="h-screen flex items-center justify-center snap-start">
      ...
      {/* Layer 3 Section */}
      <section id="section-3" className="h-screen flex items-center justify-center snap-start">
        <div className="max-w-6xl mx-auto space-y-8 p-8 backdrop-blur-md bg-white/80 rounded-2xl m-8 border border-gray-200 hover:border-gray-300 transition-all duration-300 shadow-lg">
          <h3 className="text-4xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-rose-500 to-orange-400">
