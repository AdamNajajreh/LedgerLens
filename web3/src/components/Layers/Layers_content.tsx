...
export const Layers_content = () => {
  ...
  return (
    <div className="h-screen w-full overflow-y-scroll text-white snap-y snap-mandatory relative">
      ...
      >
        <div className="max-w-4xl mx-auto text-center space-y-8 p-8 backdrop-blur-md bg-white/80 rounded-2xl m-8 border border-gray-200 hover:border-gray-300 transition-all duration-300 shadow-lg">
          ...
          <p className="text-2xl text-gray-700">
            Discover how Ethereum's multi-layer architecture enables
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
            <div className="flex-1">
              <p className="text-xl leading-relaxed text-gray-700 mb-4">
                Ethereum's base layer, where all transactions are ultimately
                settled. This layer provides:
              </p>
        ...
        <div className="max-w-6xl mx-auto space-y-8 p-8 backdrop-blur-md bg-white/80 rounded-2xl m-8 border border-gray-200 hover:border-gray-300 transition-all duration-300 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="p-6 rounded-xl border border-gray-100 bg-white shadow-sm hover:shadow-md transition-all duration-300">
              <h4 className="text-2xl font-semibold mb-4 text-rose-500">
                Rollups
              </h4>
              <p className="text-gray-700 mb-4">
                Execute transactions off-chain and submit compressed data to
                Ethereum:
              </p>
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                <li>
                  <strong>Optimistic Rollups</strong> – Assume validity, rely on
                  fraud proofs if challenged.
                </li>
                <li>
                  <strong>ZK Rollups</strong> – Use cryptographic proofs for
                  fast, secure verification.
                </li>
                <li>
                  <strong>Validium</strong> – Off-chain data storage for even
                  greater scalability.
                </li>
              </ul>
            </div>
            ...
            <div className="p-6 rounded-xl border border-gray-100 bg-white shadow-sm hover:shadow-md transition-all duration-300">
              ...
              <p className="text-gray-700 mb-4">
                Other approaches to scaling with varying trust and data models:
              </p>
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                <li>
                  <strong>State Channels</strong> – Fast, off-chain interactions
                  with eventual settlement on Ethereum.
                </li>
                <li>
                  <strong>Plasma</strong> – Child chains that submit periodic
                  proofs to Ethereum.
                </li>
                <li>
                  <strong>Sidechains</strong> – Independent chains with bridges
                  to Ethereum; less secure but flexible.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-xl border border-gray-100 bg-white shadow-sm hover:shadow-md transition-all duration-300">
              ...
              <p className="text-gray-700">
                Decentralized financial applications for lending, trading,
                derivatives, and yield generation.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl border border-gray-100 bg-white shadow-sm hover:shadow-md transition-all duration-300">
              ...
              <p className="text-gray-700">
                Platforms for creating, trading, showcasing, and managing
            ...
            <div className="p-6 rounded-xl border border-gray-100 bg-white shadow-sm hover:shadow-md transition-all duration-300">
              ...
              <p className="text-gray-700">
                Interactive experiences that use blockchain for digital
                ownership, in-game assets, and immersive economies.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Scroll Navigator */}
      <div className="fixed top-1/2 right-4 pr-[15px] transform -translate-y-1/2 z-50 flex flex-col space-y-4">
        {[0, 1, 2, 3].map((i) => (
          <button
            key={i}
            onClick={() =>
