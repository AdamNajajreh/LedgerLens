...
export default function DashboardComp() {
  return (
    <main className="min-h-screen px-6 py-12 text-white flex flex-col items-center space-y-12">
      {/* Hero section */}
      <section className="w-full max-w-4xl backdrop-blur-2xl bg-white/5 rounded-xl p-6 shadow-md ring-1 ring-white/10 text-center">
        ...
        <p className="text-base">
          Navigate, analyze, and understand blockchain data through intuitive
      ...
      <section className="w-full max-w-4xl backdrop-blur-2xl bg-white/5 rounded-xl p-6 shadow-md ring-1 ring-white/10 flex flex-col md:flex-row items-start md:items-center gap-6">
        <div className="flex-1">
          ...
          <p className="text-sm leading-relaxed">
            Blockchain data is inherently interconnected—transactions link
            wallets, contracts, and blocks. LedgerLens reveals these
            relationships visually, helping you detect patterns, trace funds,
