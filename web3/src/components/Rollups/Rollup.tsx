...
export const Rollup = () => {
  ...
  return (
    <div
      ...
      className="h-screen w-full overflow-y-scroll text-white snap-y snap-mandatory relative transition-colors duration-700 ease-in-out scrollbar-hide"
    ...
    >
        ...
        {[0, 1, 2, 3].map((i) => (
          <button
            ...
            className={`w-4 h-4 rounded-full transition-all duration-300 ${
              sectionIndex === i ? "bg-orange-500 scale-125" : "bg-gray-400 hover:bg-orange-400"
            }`}
          />
        ))}
      </div>
      ...
      <div className="fixed top-0 left-0 w-full h-screen z-0">
        <Canvas camera={{ position: [0, 0, 20], fov: 45 }} style={{ background: bgColor }}>
          <MagnifyingGlass
      ...
      <div className="relative z-10">
        ...
        <section id="section-1" className="min-h-screen flex items-center justify-center snap-start">
        ...
        <section id="section-2" className="min-h-screen flex items-center justify-center snap-start">
        ...
        <section id="section-3" className="min-h-screen flex items-center justify-center snap-start">
          <div className="max-w-6xl mx-auto space-y-8 p-8">
            <h2 className="text-4xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-rose-500 to-orange-400">
              Benefits of Rollups
            </h2>
